...
<div class="w-full h-screen grid grid-cols-2 gap-4 items-start p-12 overflow-y-hidden box-border ">


    <div id="default-carousel" class="h-screen relative w-full" data-carousel="slide">
        <!-- Carousel wrapper -->
        <div class=" h-screen  relative overflow-hidden rounded-lg w-64 aspect-square mx-auto">
             <!-- Item 1 -->
        ...
        <!-- Slider controls -->
        <button type="button" class="absolute left-2 top-28 start-0 z-30 flex items-center justify-center px-4 cursor-pointer group focus:outline-none" data-carousel-prev>
        ...
        <button type="button" class="absolute right-2 top-28 end-0 z-30 flex items-center justify-center  px-4 cursor-pointer group focus:outline-none" data-carousel-next>
            <span class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-blue-navy dark:bg-gray-800/30 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
                <svg class="w-4 h-4 text-white dark:text-gray-800 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
    ...
    <div id="default-carousel" class="h-screen relative w-full" data-carousel="slide">
        ...
        <!-- Slider controls -->
        <button type="button" class="absolute left-6 top-28 start-0 z-30 flex items-center justify-centerpx-4 cursor-pointer group focus:outline-none" data-carousel-prev>
            <span class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-blue-navy dark:bg-gray-800/30  group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
                <svg class="w-4 h-4 text-white dark:text-gray-800 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 1 1 5l4 4"/>
                </svg>
