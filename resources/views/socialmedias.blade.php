...
<div class="w-full h-screen flex items-center justify-center space-x-24 overflow-y-hidden">
    ...
    <div id="default-carousel" class=" relative w-full" data-carousel="slide">
        ...
        <!-- Slider controls -->
        <button type="button" class="absolute top-28 start-0 z-30 flex items-center justify-center cursor-pointer group focus:outline-none" data-carousel-prev>
        ...
        <button type="button" class="absolute  top-28 end-0 z-30 flex items-center justify-center cursor-pointer group focus:outline-none" data-carousel-next>
            <span class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-blue-navy dark:bg-gray-800/30 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
                <svg class="w-4 h-4 text-white dark:text-gray-800 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
